        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 bg-img">
            <div class="relative hidden h-screen flex-col bg-muted p-10 items-center justify-center lg:flex">
              <img
                class="hidden h-24 bg-groq-cloud-logo bg-contain bg-center bg-no-repeat dark:bg-groq-cloud-logo-dark lg:block z-10"
                width={"100%"}
                height={"30%"}
              ...
              <div class="relative z-20">
                <div
                  class="inline-block transition duration-200 ease-in-out text-content-emphasis font-medium"
                  style={{ fontSize: "20px" }}
                >
          ...
          <div
            class={`col-lg-6 col-md-12 form-section ${styles.login_section_container}`}
          >
