        ...
        <div role="listitem" key={{link}}>
            <div className="xeuugli x2lwn1j x6s0dn4 x78zum5 xl56j7k x5yr21d">
                <div className="xeuugli x2lwn1j x6s0dn4 x78zum5">
                    <div aria-expanded="false" className="x1i10hfl x1qjc9v5 xjbqb8w xjqpnuy xa49m3k xqeqjp1 x2hbi6w x13fuv20 xu3j5b3 x1q0q8m5 x26u7qi x972fbf xcfux6l x1qhh985 xm0m39n x9f619 x1ypdohk x78zum5 xdl72j9 xdt5ytf x2lah0s xe8uvvx xdj266r x11i5rnm xat24cr x1mh8g0r x2lwn1j xeuugli xkhd6sd x1n2onr6 x16tdsg8 xggy1nq x1ja2u2z x1t137rt x1hl2dhg x1lku1pv xqmdsaz x1y1aw1k xwib8y2" role="button" tabIndex="0">
                        <a className={`inline-block transition duration-200 ease-in-out hover:text-primaryaccent text-content-emphasis font-medium ${styles.nav_link}`}>
                            {name}
                        </a>
                    </div>
                </div>
    ...
    return(
        <header className="px-3 py-4 md:px-6 md:py-7 flex md:grid md:grid-cols-6 h-[72px] md:h-[96px]">
					    ...
					    <div className="xeuugli x2lwn1j x1qjc9v5 x78zum5 x1nhvcw1 x5yr21d x1gcox1g">
						    <div className="xeuugli x2lwn1j x1qjc9v5 x78zum5 xl56j7k">
							    <div className="x78zum5 xkh2ocl xl56j7k" role="list">
								    {navRoutes.map(({name, link}) => <NavLink name={name} link={link} />)}
            ...
            <a href="/" className="h-[40px] fixed top-4 left-3 md:top-7 md:left-6">
                <img src="logo.png" width="auto" height="auto" className={styles.logo} />
            </a>
	    </header>
    );
}
